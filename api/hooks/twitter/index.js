...
module.exports = function twitter(sails) {
    ...
    function Twitter(options) {
            ...
            this.options = extend({
                ...
                bearer_token: null,
                rest_base: sails.config[self.configKey].rest_base,
                stream_base: sails.config[self.configKey].stream_base,
                user_stream_base: sails.config[self.configKey].user_stream_base,
                site_stream_base: sails.config[self.configKey].site_stream_base,
                media_base: sails.config[self.configKey].media_base,
                request_options: {
                headers: {
                    Accept: '*/*',
                    Connection: 'close',
   ...
   return {
        configure: function(){
            ...
            sails.config[this.configKey].site_stream_base='https://sitestream.twitter.com/1.1';
            sails.config[this.configKey].media_base='https://upload.twitter.com/1.1';
